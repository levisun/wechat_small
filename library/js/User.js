...
export default class extends Base
{
    ...
    getSystemInfo(_callback)
    {
        wx.getSystemInfo({
            ...
            {
                _callback(false);
                self.logError('User->getSystemInfo::wx.getSystemInfo', result);
            },
    ...
    getAddress(_callback)
    {
        wx.chooseAddress({
            ...
            {
                _callback(false);
                self.logError('User->getAddress::wx.chooseAddress', result);
            },
            complete: function(result)
            {
                // code
            ...
            wx.login({
                success: function(result)
                {
                    wx.request({
                        ...
                        fail: function(res)
                        {
                            self.logError('User->request::wx.request', res);
                        },
    ...
    authorize(_params)
    {
        ...
        wx.authorize({
            ...
            fail: function(result) {
                self.logError('User->authorize::wx.authorize', result);
            },
            complete: function(result) {
                // code...
            }
